  ...
  return (
    <aside className="workstation-region min-h-0 overflow-auto bg-paper">
      ...
      <div className="divide-y divide-rule">
        ...
        <section className="min-h-0 bg-porcelain/58 p-4">
          <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
          <div className="min-w-0">
            <p className="rule-label">Written diagnostics</p>
            <h3 className="display-title text-2xl">Recommendations</h3>
          </div>
          {result?.api_error && (
        ...
        <div className="max-h-[260px] overflow-auto whitespace-pre-wrap border-l-2 border-teal pl-3 text-sm leading-6 text-ink-soft">
          {result?.response || "Recommendations appear after analysis."}
        </div>
        </section>
